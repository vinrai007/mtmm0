...
const NewsletterSubscriptionForm = () => {
  useEffect(() => {
    // Load the Brevo JavaScript by appending a script tag to the document
    ...
    <div id="sib-form-container" className="sib-form-container">
      ...
      >
        <form
          id="sib-form"
          method="POST"
          action="https://f3c18910.sibforms.com/serve/MUIFABDrFofFglkCFNsJO8APfB-Lp2lrmOpcYswLDUtnhGGzOvMmZlWpOa2lwYdscPuro_rxIJ7GxvI2SlEg5eUH1J46d-KGSax7L5WrcnRDrxU7jg0f-Omk7rjEOLGmiakYmBII-9bt_zwWjrui5kY--oTWaZ8ZO-xGeC4FKTOQVsFaWSTepQFoE9EiofFQrf97i7k2dq-XWwpf"
        ...
        >
          ...
          {/* <div style={{ padding: "8px 0" }}>
            <div className="sib-form__declaration" style={{ direction: "ltr" }}>
              ...
              >
                We use Brevo as our marketing platform. By clicking below to
                submit this form, you acknowledge that the information you
                provided will be transferred to Brevo for processing in
